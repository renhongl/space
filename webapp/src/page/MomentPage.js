      ...
      <Responsive {...Responsive.onlyComputer}>
        <Visibility once={false} onBottomPassed={this.showFixedMenu} onBottomPassedReverse={this.hideFixedMenu}>
          <Segment inverted textAlign='center' style={{ minHeight: 700, padding: '1em 0em' }} vertical>
            ...
            >
              <Container>
                <Menu.Item as='span' ><Link to="/">主页</Link></Menu.Item>
                <Menu.Item as='span' active><Link to="/moment">瞬间</Link></Menu.Item>
                <Menu.Item as='span'><Link to="/album">相册</Link></Menu.Item>
                <Menu.Item as='span'><Link to="/messageboard">留言板</Link></Menu.Item>
      ...
      <Responsive {...Responsive.onlyMobile}>
        <Sidebar.Pushable>
          <Sidebar as={Menu} animation='uncover' inverted vertical visible={sidebarOpened}>
            ...
            <Menu.Item as='a'>瞬间</Menu.Item>
            <Menu.Item as='a'>相册</Menu.Item>
